...
#
# Parts:
#   1. Untied cosine: λ=0 (baseline), λ=1.6, 6.4  (λ=0.1 and 0.4 done in sweep 2)
...
# λ=0.1 and λ=0.4 already done in sweep 2 (221812).
echo ""
echo "======================================================"
echo " Part 1: Untied cosine  (baseline + λ=1.6, 6.4)"
echo "======================================================"
